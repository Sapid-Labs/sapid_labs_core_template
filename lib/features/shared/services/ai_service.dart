...
import 'package:sapid_labs_core/features/shared/services/custom_http_client.dart';
...
class AIService {
  ...
  CustomHttpClient createCustomHttpClient() {
    return CustomHttpClient(
      defaultHeaders: {
        'User-Agent': 'SapidLabsCore/1.0',
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'X-Android-Package': 'com.sapidlabs.sapid_labs_core',
